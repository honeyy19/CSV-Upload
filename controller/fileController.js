...
// DELETING THE FILE
const purgeFile = asyncHandler(async (req, res) => {
   try {
...
// SHOWING THE FILE
const displayFiles = asyncHandler(async (req, res) => {
   // FIND THE FILE BY ID
   ...
   fs.createReadStream(filePATH.filePath)
      ...
      .on("end", () => {
         ...
         let startSlice = page == 1 ? (page - 1) * 100 : (page - 1) * 100 + 1;
...
module.exports = { home, uploadFile, purgeFile, displayFiles };